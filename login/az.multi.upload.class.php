...
class ImageUploadAndResize{
	...
	public function uploadFiles($yourFileName, $yourDestination, $createThumb=false, $minImgWidth=400, $waterMarkImgSrc="", $xPosition="", $yPosition="", $reName="", $permission=0777, $quality=100, $newWidth="", $thumbWidth=""){
